<?php
/**
 * Homepage functions and definitions
 *
...
if ( ! function_exists( 'homepage_setup' ) ) :
	/**
	...
	function homepage_setup() {
		 ...
		 * If you're building a theme based on Homepage, use a find and replace
		 * to change 'homepage' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'homepage', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'homepage' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'homepage_custom_background_args',
				array(
 ...
 */
function homepage_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'homepage_content_width', 640 );
}
add_action( 'after_setup_theme', 'homepage_content_width', 0 );
...
function homepage_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'homepage' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'homepage' ),
